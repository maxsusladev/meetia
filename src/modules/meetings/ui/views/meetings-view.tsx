...
export const MeetingsIdViewLoading = () => {
    return (
        <LoadingState title="Loading Meetings" description="This nay take a few seconds..." />
    )
}

export const MeetingsIdViewError = () => {
    return (
        <ErrorState title="Error loading Meetings" description="Please try Meetings later" />
    )
}